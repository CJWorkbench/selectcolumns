...
from selectcolumns import migrate_params, render
...
class RenderTest(unittest.TestCase):
    ...
    def test_render_range_ignore_empty_range(self):
        ...
        self.assertEqual(
            result, i18n_message("badParam.column_numbers.invalid", {"value": ""},),
        )
    ...
    def test_render_range_overlapping_ranges(self):
        ...
        self.assertEqual(result, i18n_message("badParam.column_numbers.overlapping"))

    def test_render_range_clamp_range(self):
        table = pd.DataFrame({"A": [1, 2], "B": [2, 3], "C": [3, 4]})
        result = render(table, P(select_range=True, column_numbers="-1,2,6"))
        self.assertEqual(
            result, i18n_message("badParam.column_numbers.invalid", {"value": "-1"},)
        )
    ...
    def test_render_range_non_numeric_ranges(self):
        ...
        self.assertEqual(
            result,
            i18n_message("badParam.column_numbers.invalid", {"value": "giraffe"},),
        )
